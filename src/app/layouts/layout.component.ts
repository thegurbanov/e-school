...
export class LayoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.layoutMode = localStorage.getItem("theme") ?? 'light'
      ;
    // default settings
  ...
  LayoutMode(mode: string) {
    ...
    document.body.setAttribute("data-topbar", localStorage.getItem("theme") ?? 'light');
    document.body.setAttribute("data-sidebar", localStorage.getItem("theme") ?? 'light');
