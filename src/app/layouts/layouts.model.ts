...
export const LAYOUT_MODE = localStorage.getItem("theme") ?? 'light';

export const LAYOUT_WIDTH = 'fluid';

export const LAYOUT_POSITION = 'fixed';

export const TOPBAR = localStorage.getItem("theme") ?? 'light';

export const SIDEBAR_SIZE = 'default';

export const SIDEBAR_COLOR = localStorage.getItem("theme") ?? 'light';
